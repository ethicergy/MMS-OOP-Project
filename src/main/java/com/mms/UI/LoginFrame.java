...
public class LoginFrame extends JFrame {
    public LoginFrame() {
        ...
        topPanel.add(appTitle, BorderLayout.WEST); // leftmost
        ...
        heading.setBorder(BorderFactory.createEmptyBorder(40, 0, 40, 0));

        contentPane.add(heading, BorderLayout.CENTER);
